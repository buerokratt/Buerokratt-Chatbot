...
export const RESPONSE_PROCESSING_NOTICE_LENGTH = 60;
export const RESPONSE_WAITING_TIME_MIN = 1;
export const RESPONSE_WAITING_TIME_MAX = 120;
export const USER_IDLE_STATUS_TIMEOUT = 300000; // milliseconds
export const AWAY_STATUS_TIMEOUT_MIN = 5; // minutes
export const AWAY_STATUS_TIMEOUT_MAX = 120; // minutes
export const WIDGET_TIMING_SECONDS_MIN = 1;
export const WIDGET_TIMING_SECONDS_MAX = 10;
