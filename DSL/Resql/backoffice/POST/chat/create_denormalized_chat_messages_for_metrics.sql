...
SELECT
    ...
    CASE WHEN (SELECT value) ->> 'message_event' = 'null' THEN NULL ELSE LOWER((SELECT value) ->> 'message_event')::event_type END,
    CASE WHEN (SELECT value) ->> 'message_author_role' = 'null' THEN NULL ELSE ((SELECT value) ->> 'message_author_role')::author_role_type END,
