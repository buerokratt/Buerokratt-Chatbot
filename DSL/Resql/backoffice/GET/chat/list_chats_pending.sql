...
SELECT
    ...
    c.last_message_with_content_and_not_rating_or_forward AS last_message,
    c.contacts_message,
    c.last_message_with_not_rating_or_forward_events_timestamp AS last_message_timestamp,
    c.last_non_empty_message_event AS last_message_event,
    c.csa_title
