...
-- changeset liquibase:1719279300826-1
CREATE TYPE user_status AS ENUM ('active','deleted');

-- changeset liquibase:1719279300826-2
CREATE TYPE status AS ENUM ('online','idle', 'offline')

-- changeset liquibase:1719279300826-3
...
-- changeset liquibase:1719279300826-4
...
INSERT INTO "configuration" ("id", "key", "value", "deleted", "created") VALUES (5, 'widgetBubbleMessageText', 'Küsi minult!', FALSE, NULL);
...
-- changeset liquibase:1719279300826-5
...
-- changeset liquibase:1719279300826-6
...
-- changeset liquibase:1719279300826-7
...
-- changeset liquibase:1719279300826-8
...
-- changeset liquibase:1719279300826-9
...
-- changeset liquibase:1719279300826-10
...
-- changeset liquibase:1719279300826-21
...
-- changeset liquibase:1719279300826-22
...
-- changeset liquibase:1719279300826-23
...
-- changeset liquibase:1719279300826-24
