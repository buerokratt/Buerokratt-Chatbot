...
| [Notification of the authentication result](https://github.com/buerokratt/Buerokratt-Chatbot/issues/46)                    | /login-with-tara-jwt |     cs-get-messages-by-chat-id "event": "authentication_successful"                                                     |                                                                             |
