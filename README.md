...
For production deploying on kubernetes use this the variable [`REACT_APP_MENU_JSON`](https://github.com/buerokratt/NoOps/blob/dev/Kubernetes/Modules/Buerokratt-Chatbot/templates/deployment-byk-backoffice-gui.yaml):
```
